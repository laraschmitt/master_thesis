# GENERATE CLEANED UP DATASETS FOR PLANTIX IMAGES FROM ANDHRA PRADESH FOR 2017, 2018 AND 2019 
# AND APPLY FIRST COARSE FILTER STEPS
# CREATE COUNTS FOR EVERY FILTER STEP
...
df_jan_march_2017 = pd.read_csv(path + '<NAME_CSV_FILE>')
df_jan_march_2018 = pd.read_csv(path + '<NAME_CSV_FILE>')
df_jan_march_2019 = pd.read_csv(path + '<NAME_CSV_FILE>')
...
# ['Plantix' 'Plantix Preview' 'Gatherix' 'com.peat.GartenBank', 'Plantix Huawei' 'com.peat.GartenBank.preview']
...
# check amount of plantix vs. gatherix images for documentation
# 2017
...
print('df_2017_ff_unique_pla_id', len(df_2017_ff_unique_pla_id)) 
print('df_2018_ff_unique_pla_id', len(df_2018_ff_unique_pla_id))  
print('df_2019_ff_unique_pla_id', len(df_2019_ff_unique_pla_id)) 
...
# check amount of plantix vs. gatherix images for documentation
print('df_2017_unique_pla_id unique latlong',len(df_2017_ff_unique_pla_id_latlongcrop))  
print('df_2018_unique_pla_id unique latlong',len(df_2018_ff_unique_pla_id_latlongcrop))  
print('df_2019_unique_pla_id unique latlong',len(df_2019_ff_unique_pla_id_latlongcrop))  
...
print('df_2017_ul_ff',len(df_2017_ul_ff)) 
print('df_2018_ul_ff',len(df_2018_ul_ff))  
print('df_2019_ul_ff',len(df_2019_ul_ff))  

# check amount of plantix vs. gatherix images for documentation
# 2017
df_2017_ul_ff_plantix = df_2017_ul_ff[df_2017_ul_ff['app_name'].isin(['Plantix'])]
print('df_2017_ul_ff_plantix', len(df_2017_ul_ff_plantix)) 
df_2017_ul_ff_gatherix = df_2017_ul_ff[df_2017_ul_ff['app_name'].isin(['Gatherix'])]
print('df_2017_ul_ff_gatherix', len(df_2017_ul_ff_gatherix))  

# 2018
df_2018_ul_ff_plantix = df_2018_ul_ff[df_2018_ul_ff['app_name'].isin(['Plantix'])]
print('df_2018_ul_ff_plantix', len(df_2018_ul_ff_plantix)) 
df_2018_ul_ff_gatherix = df_2018_ul_ff[df_2018_ul_ff['app_name'].isin(['Gatherix'])]
print('df_2018_ul_ff_gatherix', len(df_2018_ul_ff_gatherix))  
...
# create new photo taken time column
...
gallery_2017 = pd.read_csv(path + '<NAME_CSV_FILE>')
gallery_2018 = pd.read_csv(path + '<NAME_CSV_FILE>')
gallery_2019 = pd.read_csv(path + '<NAME_CSV_FILE>')
...
########################## export #####################################################
df_2017_ul_ff_DNN_notgall.to_csv(path + '<NAME_CSV_FILE>'), header=True,  index=False, encoding='utf-8')
df_2018_ul_ff_DNN_notgall.to_csv(path + '<NAME_CSV_FILE>'), header=True,  index=False, encoding='utf-8')
df_2019_ul_ff_DNN_notgall.to_csv(path + '<NAME_CSV_FILE>'), header=True,  index=False, encoding='utf-8')
