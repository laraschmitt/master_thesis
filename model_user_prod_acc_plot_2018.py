...
plt.errorbar(92.65, 8, xerr=1.03/2,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, label = 'PA', color='g') # , label='prod acc_model 2018 DNN 50 ACC 100\'s'
...
plt.savefig("/Users/lara/thesis_data/pyplots/model_UA_PA_2018.png", format="png", dpi=300)
plt.show()