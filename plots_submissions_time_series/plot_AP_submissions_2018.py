...
#print('2018 unique pla ids', len(whole2018['pla_id'].unique()))  # 467041

#df_plantix = whole2018[whole2018['app_name'].isin(['Plantix', 'Plantix Preview'])]
#print('2018 only plantix',len(df_plantix))  # 411846

#df_ff= df_plantix[df_plantix['feedforward_integer'].isin([5, 4, 3])]
#print('2018 only plantix only plants',len(df_ff)) #278853

## share of 0.677 % of all plantix submissions in 2018 (Andhra Pradesh) was detected as plant

#whole2018_all_fields = pd.read_csv('/Users/lara/thesis_data/PEAT_data/2018_whole_year_all_fields.csv')
...
plt.savefig("/Users/lara/thesis_data/pyplots/plot_AP_plantix_2018.png", format="png", dpi=600)
plt.show()