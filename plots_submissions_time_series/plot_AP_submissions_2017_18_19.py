...
# new:
whole2019 = pd.read_csv('/Users/lara/thesis_data/PEAT_data/2019_whole_year_AP-filtered.csv')
jan2020 = pd.read_csv('/Users/lara/thesis_data/PEAT_data/2020_january_AP.csv')
...
print(df_2019_plantix.head(200))
#df_2019_plantix = whole2019[whole2019['app_name'].isin(['Plantix', 'Plantix Preview',  'com.peat.GartenBank', 'Plantix Huawei','com.peat.GartenBank.preview'])]
...
plt.savefig("/Users/lara/thesis_data/pyplots/plot_AP_2017_2019_2020.png", format="png", dpi=600)
plt.show()