...
#print(len(whole2017))  # 508453
#print(len(whole2017['pla_id'].unique()))  # 223629

dropped2017 = whole2017.drop_duplicates(['pla_id'])
print(len(dropped2017))
print(dropped2017.head())
for col in dropped2017.columns:
    print(col)
...
print('2018 unique pla ids', len(whole2018['pla_id'].unique()))  #
...
print('2019 unique pla ids', len(whole2019['pla_id'].unique()))  #
