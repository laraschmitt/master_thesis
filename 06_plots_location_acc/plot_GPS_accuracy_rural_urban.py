...
# import datasets for after filtered for urban areas and roads
...
print('test',len(df.loc[df['non_urban'] == 2]))   
print('test2',len(df.loc[df['non_urban'] == 1])) 
...
plt.savefig(path + "GPS_rural_urban_allyears.png", format="png", dpi = 600)
