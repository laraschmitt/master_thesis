...
df1 = pd.DataFrame(plantix_data1).dropna()

#df1.to_csv("/Users/lara/thesis_data/2019_AP_jan_march_district_acc_date_userid_gallery.csv")
df1.to_csv("/Users/lara/thesis_data/2017_AP_jan_march_id_image_from_gall.csv")