...
*/\
\
// import the feature matrix// training \
\
\
/*\
// DNN 50, ACC 100\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_dnn50_acc100_3200_td_noncropped_3200_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_dnn50_acc100_3200_td_noncropped_3200_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_dnn50_acc100_3200_td_noncropped_3200_2019')\
\
\
// DNN 50, ACC 30\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_dnn50_acc30_3200_td_noncropped_3200_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_dnn50_acc30_3200_td_noncropped_3200_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_dnn50_acc30_3200_td_noncropped_3200_2019')\
*/\
\
/*\
// DNN 50, ACC 10\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_dnn50_acc10_3200_td_noncropped_3200_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_dnn50_acc10_3200_td_noncropped_3200_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_dnn50_acc10_3200_td_noncropped_3200_2019')\
\
\
// DNN 80, ACC 100\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_dnn80_acc100_3200_td_noncropped_3200_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_dnn80_acc100_3200_td_noncropped_3200_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_dnn80_acc100_3200_td_noncropped_3200_2019')\
\
\
\
\
// DNN 80, ACC 30\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_dnn80_acc30_3200_td_noncropped_3200_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_dnn80_acc30_3200_td_noncropped_3200_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_dnn80_acc30_3200_td_noncropped_3200_2019')\
\
\
\
// DNN 80, ACC 10\
...
\
// topcrops\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_TOPCROPS_dnn80_acc10_2800_td_noncropped_2800_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_TOPCROPS_dnn80_acc10_2800_td_noncropped_2800_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_TOPCROPS_dnn80_acc10_2800_td_noncropped_2800_2019')\
\
\
\
...
*/\
\
var training_2017 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2017/td_peat_201819_dnn80_acc10_1400_td_noncropped_1400_2017')\
var training_2018 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2018/td_peat_201819_dnn80_acc10_1400_td_noncropped_1400_2018')\
var training_2019 = ee.FeatureCollection('users/laraschmitt1991/training_data/combined_2019/td_peat_201819_dnn80_acc10_1400_td_noncropped_1400_2019')\
\
...
Export.image.toAsset(\{\
  image: classified_5_classes_2017_2018_2019.clip(aoi),\
  description: 'DNN80_ACC30_2018_2019_7756',\
  assetId: 'classified_maps/DNN80_ACC30_2017_2018_2019_7756',\
  scale: 30,\
  crs: 'EPSG:7756', // Projected CRS used in India - Andhra Pradesh and Telangana\
  region: aoi,\
  maxPixels: 697591435\
\});\
\
////////////////////// ACCURACY ASSESSMENT///////////////////////////////////\
\
//upload validation data sets for whole map\
var ref_feat_2017 = ee.FeatureCollection('users/laraschmitt1991/validation_data/ref_feat_2017')\
var ref_feat_2018 = ee.FeatureCollection('users/laraschmitt1991/validation_data/ref_feat_2018')\
var ref_feat_2019 = ee.FeatureCollection('users/laraschmitt1991/validation_data/ref_feat_2019')\
\
