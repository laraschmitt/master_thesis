...
\
// load shapefile of Andhra Pradesh borders and add to the map \
...
/////////////////////////////////////////////////////////////////////////////\
\
// load L5, L7, L8 collections and select bands \
\
\
// define startDate and endDate\
var startDate = '2019-01-01'\
var endDate = '2019-04-30'\
var cloudCoverMax = 20.0\
\
...
var l8 = ee.ImageCollection('LANDSAT/LC08/C01/T1_SR')\
      ...
      //.filterMetadata('CLOUD_COVER', 'less_than', cloudCoverMax)\
      \
// merge to one big collection\
var landsatCollFilt = ee.ImageCollection(l8.merge(l7).merge(l5).merge(l4));\
\
print(landsatCollFilt)\
\
///////////////////////////////////////////////////////////////////////////////\
\
\
...
var landsatCollFilt_WRSPR = landsatCollFilt.map(function(feature) \{\
...
\
var WRSPR_list = ee.List(landsatCollFilt_WRSPR.aggregate_array('WRSPR'));\
\
//print(WRSPR_list)\
\
///////////////////////////////////////////////////////////////////////////////\
\
// iterate over the wrs2_filterted collection and for each feature get the \
// WRSPR code, then get the count of this code in the list and set the count as \
//a new property in the wrs2_filtered collection\
\
...
Export.table.toDrive(\{\
  ...
  description:'Acquired_2019_jan_to_april',\
  fileFormat: 'SHP'\
\});\
\
\
