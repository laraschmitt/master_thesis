...
plt.errorbar(92.65, 8, xerr=1.03,
            fmt='.', elinewidth=1, markersize=4, capsize=3, capthick=0.5, label = 'PA', color='g') # prod acc_model 2018 DNN 50 ACC 100
...
plt.errorbar(98.57, 5 ,xerr=np.array([[0.98 , 1.0]]).T,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') #prod acc_model 2018 bestestime
...
plt.errorbar(97.36, 8, xerr=2.77,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_model 2018 DNN 50 ACC 100\'s'
plt.errorbar(87.67, 8, xerr=3.73,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc_model 2018 DNN 50 ACC 100\'s'
plt.errorbar(96.63, 7, xerr=2.97,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_model 2018 DNN 50 ACC 30\'s'
plt.errorbar(86.33, 7, xerr=3.89,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc_model 2018 DNN 50 ACC 30\'s'
plt.errorbar(96.56, 6, xerr=2.91,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_model 2018 DNN 50 ACC 10\'s'
plt.errorbar(88.67, 6, xerr=3.59,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc_model 2018 DNN 50 ACC 10\'s'
plt.errorbar(97.40, 5, xerr=2.74,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_model 2018 DNN 80 ACC 100\'s
...
plt.errorbar(96.05, 3, xerr=3.1/2,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_model 2018 DNN 80 ACC 10\'s'
...
plt.errorbar(96.09, 2, xerr=3.16,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_model 2018 topcrops\'s'
plt.errorbar(88.0, 2, xerr=3.68,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc_model 2018 topcrops\'s'
...
plt.errorbar(81.25, 1, xerr=4.08,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') #  label='user acc_model 2018 bestestimate
