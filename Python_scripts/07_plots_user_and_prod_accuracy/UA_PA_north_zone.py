...
plt.errorbar(94.96, 1, xerr=2.1,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5,  color='g') # prod 80
plt.errorbar(93.00, 1, xerr=5.03,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5,  color='b') # user 80
plt.errorbar(90.04, 0, xerr=4.38,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5,  color='g') # prod acc_best
...
plt.errorbar(100.0, 1, xerr=0,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user80
plt.errorbar(69.21, 0, xerr=29.24,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod accbest
...
plt.errorbar(70.05, 1, xerr=14.91,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_80'
plt.errorbar(92.00, 1, xerr=7.6,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc_m80

plt.errorbar(65.06, 0, xerr=11.57,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_best
plt.errorbar(92.00, 0, xerr=7.60,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc_best'
...
plt.errorbar(98.5, 1, xerr=2.91,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # prod acc_m80
plt.errorbar(99, 1, xerr=1.96,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # user acc80'
...
plt.errorbar(58., 1, xerr=13.82,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # , user acc_80

plt.errorbar(76.17, 0, xerr=23.76,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='g') # , prod abest
plt.errorbar(76, 0, xerr=11.96,
            fmt='.', elinewidth=1, markersize=3, capsize=3, capthick=0.5, color='b') # , user best
