#### setting up  testdata table
import pandas as pd
import numpy as np

pred = pd.read_csv('<PATH_TO_INPUT_CSV_FILE>')
...
print(len(df2))
df2.to_csv('<PATH_TO_OUTPUT_CSV_FILE>', header=True,  index=False, encoding='utf-8')
...
df_filtered.to_csv('<PATH_TO_OUTPUT_CSV_FILE>', header=True,  index=False, encoding='utf-8')