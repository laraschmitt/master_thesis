...
print('share 1-10', (betw_1_10/total_l)) # 9.1%
print('share 10-30', (betw_10_30/total_l)) # 7.8%
print('share 30-100', (betw_30_100/total_l)) # 7.6%
print('share 100-4000', (betw_100_4000/total_l)) # 67.0%
print('share no acc', (no_acc/total_l))  # 9.1%
...
######## ALWAYS COMMENT THE OTHER TWO PLOTS OUT TO BE ABLE TO PLOT ###############
...
plt.savefig("/Users/lara/thesis_data/pyplots/GPS_acc_overview.png", format="png", dpi = 600)
plt.show()
